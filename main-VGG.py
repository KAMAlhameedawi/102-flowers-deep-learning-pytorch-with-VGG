...
# Set the path to the 'flowers' directory
flowers_path = 'flowers'

# Check if the 'flowers' directory exists
if os.path.exists(flowers_path):
    # Print the contents of the 'flowers' directory
    print(f"Contents of '{flowers_path}':", os.listdir(flowers_path))
    
    # Set the path to the 'train' directory inside 'flowers'
    train_path = os.path.join(flowers_path, 'train')
    ...
    print(f"The path '{flowers_path}' does not exist.")
